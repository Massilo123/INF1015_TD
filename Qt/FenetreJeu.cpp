...
namespace vue
{
		...
		QMainWindow(parent)
	{
		...
		QObject::connect(&partie_, &modele::Partie::pieceDeplacee, this, &FenetreJeu::mettreAJourAffichage);
		QObject::connect(&partie_, &modele::Partie::mouvementInvalide, this, &FenetreJeu::retroactionErreur);
	...
	void FenetreJeu::ajouterPiece(std::unique_ptr<modele::Piece> piece)
	{
